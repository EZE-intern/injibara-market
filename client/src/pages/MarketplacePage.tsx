    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        ...
        <section className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Link
            to="/customer/saved"
            className="rounded-2xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 transition-all hover:-translate-y-1 hover:border-brand-200 hover:shadow-md"
          >
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-brand-100 dark:bg-brand-950/60 text-brand-700 dark:text-brand-400">
              <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
              View and manage products you have bookmarked for later.
            </p>
          </Link>
