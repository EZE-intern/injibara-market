              ...
              <section>
                ...
                <div className="rounded-xl border border-gray-200 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-semibold text-slate-900">
                        {selectedInquiry.seller?.full_name ?? "Unknown seller"}
                      </p>

                      {selectedInquiry.seller?.phone ? (
                    ...
                    {selectedInquiry.seller?.phone && (
                      <a
                        href={`tel:${selectedInquiry.seller.phone}`}
                        className="inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-emerald-700 cursor-pointer"
                  ...
                  <div className="mt-3 flex items-start gap-2 rounded-lg bg-amber-50/90 p-2.5 text-xs text-amber-800 border border-amber-200/70">
                    <Phone className="h-3.5 w-3.5 mt-0.5 shrink-0 text-amber-600" />
                    <p className="leading-snug">
                      <strong>Brokered Asset Policy:</strong> Contact the seller directly via phone call. In-app messaging is strictly between Buyer and Admin.
                    </p>
                  </div>
                </div>
              </section>
