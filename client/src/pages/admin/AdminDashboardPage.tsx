...
function AdminDashboardPage() {
  ...
  const stats = [
    ...
    {
      title: "Fayda Verified Sellers",
      value: overview
        ? overview.faydaVerifiedSellers.toLocaleString()
        : "—",
      description: "Successfully verified sellers",
      icon: "♢",
    },
    {
        ...
        {stats.map((stat) => (
          ...
          >
            ...
            <div className="flex items-start justify-between">
              ...
              {/* Icon */}
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gray-100 text-lg text-slate-600">
                {stat.icon}
              </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="ml-auto text-gray-400 transition group-hover:translate-x-1">
                →
              </span>
