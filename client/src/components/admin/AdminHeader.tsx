      ...
      <div className="flex h-full items-center justify-between px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden items-center gap-2 rounded-xl border border-gray-200 px-4 py-2.5 md:flex">
            ...
            <input
              type="text"
              placeholder="Search deals, users, stores..."
          ...
          <button
            type="button"
            className="relative flex h-11 w-11 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-600"
          >
